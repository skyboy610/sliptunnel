...
print_banner() {
    ...
    echo -e "  ${BG_YELLOW}${FG_BLUE}${BOLD}  ${BG_BLUE}${FG_YELLOW}${BOLD}     DNS Covert Channel v4             ${RST}${BG_YELLOW}  ${RST}"
    echo -e "  ${BG_YELLOW}${FG_BLUE}${BOLD}  ${BG_BLUE}${FG_YELLOW}${BOLD}                                      ${RST}${BG_YELLOW}  ${RST}"
    echo -e "  ${BG_YELLOW}${FG_BLUE}${BOLD}                                          ${RST}"
    echo ""
}
...
print_banner() {
    ...
    echo -e "  ${BG_YELLOW}${FG_TEAL}${BOLD}  ${BG_TEAL}${FG_YELLOW}${BOLD}     DNS Covert Channel v4            ${RST}${BG_YELLOW}  ${RST}"
    echo -e "  ${BG_YELLOW}${FG_TEAL}${BOLD}  ${BG_TEAL}${FG_YELLOW}${BOLD}                                      ${RST}${BG_YELLOW}  ${RST}"
    echo -e "  ${BG_YELLOW}${FG_TEAL}${BOLD}                                          ${RST}"
    echo ""
}
